...
var config = {
  ...
  Proxy: '',
  SecretId: 'AKIDOm39GMsODrLmQ0zdiEgxEOOCoEe34eCb', // 固定密钥
  SecretKey: 'NYYQ8gKn4A3zocFm8IH4e1GMOJ4jDWin', // 固定密钥
  Bucket: 'yanghh-1257985107',
  Region: 'ap-shanghai',
...
exports.stsAuth = function(req, res, next) {
  // 获取临时密钥，计算签名
